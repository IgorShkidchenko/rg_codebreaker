...
RSpec.describe Console do
  ...
  #         expect { subject.guess_error }.to output(/You need to enter 'hint' or four /).to_stdout
  #       end
  ...
  #         choice = ''
  #         expect { subject.choice_error(choice) }.to output(/You have passed unexpected command /).to_stdout
  #       end
  ...
  #         lvl = ''
  #         expect { subject.difficult_error(lvl) }.to output(/I dont have '#{lvl}' level, try one/).to_stdout
  #       end
  #     end
  #   end
end
